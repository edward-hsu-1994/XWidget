...
namespace XWidget.Web.Mvc.JsonMask.Test.Models {
    ...
    public class Category_ActionReturnType {
        ...
        /// 子分類
        /// </summary>
        [JsonPropertyMask(key: typeof(IEnumerable<Category_ActionReturnType>), Method = MaskMethod.ReturnType)]
        public ICollection<Category_ActionReturnType> Children { get; set; }
